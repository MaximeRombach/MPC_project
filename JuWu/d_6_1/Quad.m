classdef Quad
  ...
  methods
    ...
    %RK4
    function [x_next] = RK4(quad,X,U,h)
    %
    % Inputs : 
    ...
    % Combines the inputs from all four controllers in case of non
    % reference
    function ctrl = merge_controllers_non_ref(quad, ctrl_x, ctrl_y, ctrl_z, ctrl_yaw)
